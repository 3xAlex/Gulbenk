  ...
  return (
    <section className='py-16 relative w-full '>
      ...
      <div className="w-full flex gap-3 justify-center ">
        <img className=" w-[40%] xl:w-[50%] hover:scale-110 transition-all duration-500" src="cameraa-g1.png" alt="photo"/>
        <img className=" w-[40%] xl:w-[50%] translate-y-5 sm:translate-y-7 hover:scale-110 transition-all duration-500" src="cameraa-g2.png" alt="photo"/>
      </div>
    <div className="flex-col w-full text-center lg:text-left p-5">
    <h1 className='text-[45px]'>Best selection of <br/><span className={`font-medium border-b-4 border-[#dfdfdf]`}>High Quality</span> Cameras.</h1>
