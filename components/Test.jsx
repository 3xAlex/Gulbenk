        ...
        className="w-full px-10 sm:ml-10  mx-auto text-white items-center">
          ...
          >
            ...
            <SwiperSlide>
              ...
              className="sm:w-[180px] flex pt-4 items-center">
            ...
            <SwiperSlide>
              ...
              className="sm:w-[200px] flex pt-5 items-center">
                <img src="manfrotto.png" className="w-full h-full r10:-translate-x-10"/>
              </motion.div>
            </SwiperSlide>
            <SwiperSlide>
              <motion.div
                variants={fadeIn("left","spring", 2.5, 0.5)}
              className="sm:w-[200px] flex pt-3 items-center">
            ...
            <SwiperSlide>
              <motion.div
                variants={fadeIn("left","spring", 2.5, 0.5)}
              className="sm:w-[200px] flex pt-2 items-center">
            ...
            <SwiperSlide>
              <motion.div
                variants={fadeIn("left","spring", 2.5, 0.5)}
              className="sm:w-[200px] flex pt-2 items-center">
                <img src="sutefoto.png" className="w-full h-full"/>
              </motion.div>
            </SwiperSlide>
            <SwiperSlide>
              <motion.div
            ...
            <SwiperSlide>
              <motion.div
                variants={fadeIn("left","spring", 2.5, 0.5)}
              className="sm:w-[200px] flex items-center">
