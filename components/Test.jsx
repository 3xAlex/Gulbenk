        ...
        className="w-full px-10 sm:ml-10  mx-auto text-white items-center">
          ...
          >
            ...
            <SwiperSlide>
              ...
              className="sm:w-[230px] ml-10 w-[200px] pt-2 flex items-center">
            ...
            <SwiperSlide>
              <motion.div
                variants={fadeIn("left","spring", 2.5, 0.5)}
              className="sm:w-[250px] ml-10 w-[200px] flex items-center">
            ...
            <SwiperSlide>
              <motion.div
                variants={fadeIn("left","spring", 2.5, 0.5)}
              className="sm:w-[230px] ml-[63px] w-[170px] flex pt-1 items-center">
